...
export default function SectorStoryDesktop() {
  ...
  return (
    <section ref={ref} style={{ height: `${count * 100}vh` }} className="relative bg-navy-deeper">
      <div className="sticky top-0 flex h-[100svh] w-full flex-row overflow-hidden">
        {/* Left: text */}
        <div className="relative z-10 flex w-[44%] flex-col justify-center px-14">
          ...
          <div className="mt-8 min-h-[260px]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="mt-4 font-display text-[38px] font-medium leading-[1.1] text-white lg:text-[44px]">
                  {current.title}
                </h3>
              ...
              (s, i) =>
                i === active && (
                  ...
                  >
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-r from-navy-deeper/60 via-transparent to-transparent" />
                  </motion.div>
                )
            )}
          </AnimatePresence>
