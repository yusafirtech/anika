...
export default function BusinessShowcase() {
  ...
  const vhPerItem = isDesktop ? 100 : 72;
  const current = businessShowcase[active];

  return (
    <section ref={ref} style={{ height: `${count * vhPerItem}vh` }} className="relative bg-paper">
      <div className="sticky top-0 flex h-[100svh] w-full flex-col items-center justify-center overflow-hidden px-5 py-24 md:px-8">
        <div className="mx-auto mb-8 max-w-2xl text-center md:mb-10">
          <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-navy/60">
            What We Do
          </p>
          <h2 className="mt-3 font-display text-[32px] font-medium leading-tight text-navy-deeper md:text-[44px]">
            A Connected Business Ecosystem
          </h2>
        </div>

        <div className="relative mx-auto grid w-full max-w-6xl flex-1 grid-cols-1 gap-8 md:grid-cols-[1.1fr_0.9fr] md:items-center">
          {/* Image panel */}
          <div className="relative order-1 h-[42vh] w-full overflow-hidden rounded-2xl md:order-2 md:h-[62vh]">
          ...
          <div className="order-2 md:order-1">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <h3 className="mt-3 font-display text-[26px] font-medium leading-tight text-navy-deeper md:text-[32px]">
                  {current.title}
                </h3>
