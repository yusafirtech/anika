  ...
  return (
    <section className="relative flex min-h-[85vh] w-full items-center overflow-hidden bg-navy-deeper">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 py-24 text-center md:px-8">
        <p className="text-[11px] font-semibold uppercase tracking-[0.3em] text-teal-light">{eyebrow}</p>
        <h2 className="mt-5 font-display text-[34px] font-medium leading-[1.1] text-white sm:text-[44px] md:text-[54px]">
          {heading}
        </h2>
        <p className="mx-auto mt-6 max-w-lg text-[15px] leading-relaxed text-white/65">{description}</p>
